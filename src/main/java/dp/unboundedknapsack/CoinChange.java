...
public class CoinChange {
    ...
    public static int coinChange(int[] coins, int amount) {
        ...
        // mark all of them in dp[][] as IMPOSSIBLE since we do not which ones would be possible / feasible.
        ...
        // if amount = 0, dp result = 0 since you do not need any coin to make up amount 0.
        // dp[i][0] = 0 for all i
        for (int i = 0; i <= n; i++) {
            dp[i][0] = 0;
        }
